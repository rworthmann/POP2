...
$(document).ready(function(){
    ...
    var inverterCostformatted = "R " + inverterCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// number of batteries required (j)
		var batteryQty = (totalpower * battery) / 30;
    var batteryQtyformatted = batteryQty.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0});
		//cost of batteryQty (s)
		var batteryCost = batteryQty * 6500;
    var batteryCostformatted = "R " + batteryCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// number of solar panels required (k)
		var panelQty = inverterSize / 120;
    var panelQtyformatted = panelQty.toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 0});
		// cost of solar panels (t)
		var panelCost = panelQty * 5700;
    var panelCostformatted = "R " + panelCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		//generic Qty
		var genericQty = 1;
		// cost of mounting (u)
		var mountingCost = (panelQty * mounting) + (30 * 100) + (inverterQty * 5000);
    var mountingCostformatted = "R " + mountingCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// cost of electrical work (v)
		var electricalCost = dbSplit + (5 * 360) + 2800;
    var electricalCostformatted = "R " + electricalCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// cost of installation (w)
		var installationCost = panelQty * 2000;
    var installationCostformatted = "R " + installationCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// subtotal
		var subTotal = inverterCost + batteryCost + panelCost + mountingCost + electricalCost + installationCost;
    var subTotalformatted = "R " + subTotal.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// VAT
		var vat = subTotal * 0.15;
    var vatformatted = "R " + vat.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// total cost
		var totalCost = subTotal + vat;
    var totalCostformatted = "R " + totalCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// easy payment calculations (p)
		var monthlyPayment = totalCost * 0.02611;
    var monthlyPaymentformatted = "R " + monthlyPayment.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
		// solar cost of 10 years (q)
		var solar10YearCost = totalCost / (panelQty * 14600);
    var solar10YearCostformatted = "R " + solar10YearCost.toLocaleString(undefined, {minimumFractionDigits: 2, maximumFractionDigits: 2});
    ...
    $("#qsolar").val((solar*100).toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 2}));
    $("#qbattery").val((battery*100).toLocaleString(undefined, {minimumFractionDigits: 0, maximumFractionDigits: 2}));
...
function getPDF(){
  ...
  html2canvas($(".canvas_div_pdf")[0],{useCORS: true}).then(function(canvas) {
